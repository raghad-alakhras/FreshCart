...
import { MdMail, MdOutlinePayment } from 'react-icons/md';
export default function Footer() {
  return (
<div className='px-4 bg-gray-800'>
  <div className="container mx-auto max-w-[1400px]">
      <div className="pt-12  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
      <div>
        ...
        <div className="*:flex *:items-center *:gap-3 *:text-sm *:my-2">
            <div>
                ...
                <a href="tel:+1 (800) 123-4567" className="text-gray-400">+1 (800) 123-4567</a>
            </div>
            <div>
                 <MdMail className='text-green-500'/>
                <a href="mailto:support@freshcart.com" className="text-gray-400">support@freshcart.com</a>
            </div>
            <div>
      ...
      <div>
        <h5 className="text-white mb-4">Shop</h5>
        <ul className="*:text-gray-400 *:my-2 *:text-sm">
            <li>
      ...
      <div>
        ...
        <ul className="*:text-gray-400 *:my-2 *:text-sm">
            ...
            <li>
             <Link href={'/'}>Sipping Info</Link>
            </li>
            <li>
             <Link href={'/'}>Returns & Refounds</Link>
            </li>
            <li>
    ...
    <div className="flex items-center justify-between pt-4 pb-3 *:text-sm *:text-gray-400 border-t border-gray-400">
       <p>© 2026 FreshCart. All rights reserved.</p>
       <div className="flex items-center gap-3 *:flex *:items-center *:gap-2 *:text-gray-400">
         <div>
